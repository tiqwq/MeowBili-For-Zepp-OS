...
Page(
  BasePage({
    ...
    sendReply(text) {
      this.request({
        ...
        url: `https://api.bilibili.com/x/v2/reply/add?type=1&oid=${JSON.parse(params).id}&message=${text}&plat=1&csrf=${localStorage.getItem("bili_jct")}`,
        type: "json"
      })
      .then((res) => {
        if (res.body.code == 0) {
  ...
  build() {
    ...
    const switchButton = createWidget(widget.IMG, {
      x: 144,
      y: 425,
      w: 50,
      h: 50,
