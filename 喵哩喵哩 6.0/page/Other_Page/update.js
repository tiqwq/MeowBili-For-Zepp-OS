  ...
  updateCheck() {
    updateCheck(this.page).then((result) => {
      if (result.version !== nowVersion) {
        ...
        this.state.contentTextWidget.setProperty(prop.TEXT, getText('update_content'));
        ...
        this.state.tipWidget.setProperty(prop.TEXT, getText('download_tip'));
      } else {
        this.state.updateWidget.setProperty(prop.MORE, { color: '0xffffff' });
        this.state.updateWidget.setProperty(prop.TEXT, getText('latest_version'));
        this.state.currentVersionWidget.setProperty(prop.TEXT, getText('current_device_version'));
