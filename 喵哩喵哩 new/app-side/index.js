...
async function SendBiliPOST(res,type,data,url,content_type,parameters){
  var headers = BILI_BASE_HEADERS;
  headers["Cookie"] =  "DedeUserID=" + data.DedeUserID +  
  "; DedeUserID__ckMd5=" + data.DedeUserID__ckMd5 + 
  "; SESSDATA=" + data.SESSDATA + 
...
AppSideService( 
  BaseSideService({
    ...
    onRequest(req, res) {
      ...
      } else if (req.method == "SENDBILIPOST") {
        SendBiliPOST(res,req.type,req.data,req.url,req.content_type,req.parameters)
      }
    },
