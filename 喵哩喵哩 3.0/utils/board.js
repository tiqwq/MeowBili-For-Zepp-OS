...
export function createInputMethod(url) {
    // 创建显示输入内容的文本控件
    ...
    let txtBg = createWidget(widget.FILL_RECT, { // 自定义组件容器
      x: 10,
      y: 228,
      w: 460,
      h: 185,
    ...
    biaodianbuttons.map(button => {
      let txtWd = txtGroup.createWidget(widget.BUTTON, {
        x: button.x,
        y: button.y,
        w: 40,
        h: 50,
